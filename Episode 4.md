In the last post I described the Applicative Functor, gave a brief description of deploying on-chain Plutus code and explained NixOS and the nix package managers
